                ...
                <div className="center-div">
                    ...
                    <div className="bottom">
                        <div className="overview">
                            <p className="about"><span id="span">Genre :</span> {genre_names.join(', ')} </p>
                        </div>
                        <div className="cast">
                            <p className="about"><span id="span">Cast : </span>{cast.slice(0, 4).map((names) => { return <a className="cast_link" href={`https://en.wikipedia.org/wiki/${names.name}`} >{names.name}, </a> })} {cast.slice(4,).map((names) => { return <a className="cast_link" href={`https://en.wikipedia.org/wiki/${names.name}`} >{names.name} </a> })}</p>
                        </div>
                        <div className="overview">
                            <p className="about"><span id="span">Director : </span>{director}</p>
                        </div>
                        <div className="overview">
                            <p className="about"><span id="span">Overview : </span>{movie.overview}</p>
                        </div>
                    </div>
                </div>
            </div>
